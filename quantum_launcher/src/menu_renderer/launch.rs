...
use crate::state::{
    ...
    MainMenuMessage, NotesMessage, PackageInstanceMessage, ShortcutMessage, SidebarMessage,
    SidebarScroll, WindowMessage,
};
use crate::{
    icons,
                ...
                column![
                    ...
                    ctxbox(
                        column![
                            ...
                            ctx_button_icon(icons::file_zip_s(CTXI_SIZE), "Clone Instance")
